...
export default function InstructorCourseCard({ course }) {
    return (
        <div className="border border-gray-300 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
            ...
            <button className="py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition w-full"><Link href={`/admin/courses/${course?.documentId}`}>View Details</Link></button>
        </div>
    );
}